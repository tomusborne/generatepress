import GeneratePressSelectControlForm from './GeneratePressSelectControlForm';
 ...
 */
const GeneratePressSelectControl = wp.customize.Control.extend( {
	...
	renderContent: function renderContent() {
		...
		const form = <GeneratePressSelectControlForm
			{ ...control.params }
			value={ value }
...
export default GeneratePressSelectControl;

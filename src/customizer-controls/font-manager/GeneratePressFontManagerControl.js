 ...
 */
const GeneratePressFontManagerControl = wp.customize.Control.extend( {
	...
	renderContent: function renderContent() {
		...
		const form = <GeneratePressFontManagerControlForm
			{ ...control.params }
			value={ value }
...
export default GeneratePressFontManagerControl;

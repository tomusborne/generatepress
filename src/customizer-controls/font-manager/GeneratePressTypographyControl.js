 ...
 */
const GeneratePressTypographyControl = wp.customize.Control.extend( {
	...
	renderContent: function renderContent() {
		...
		const form = <GeneratePressTypographyControlForm
			{ ...control.params }
			value={ value }
...
export default GeneratePressTypographyControl;

import GeneratePressTextControlForm from './GeneratePressTextControlForm';
 ...
 */
const GeneratePressTextControl = wp.customize.Control.extend( {
	...
	renderContent: function renderContent() {
		...
		const form = <GeneratePressTextControlForm
			{ ...control.params }
			value={ value }
...
export default GeneratePressTextControl;

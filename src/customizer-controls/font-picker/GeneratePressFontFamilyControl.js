import GeneratePressFontFamilyControlForm from './GeneratePressFontFamilyControlForm';
 ...
 */
const GeneratePressFontFamilyControl = wp.customize.Control.extend( {
	...
	renderContent: function renderContent() {
		...
		const form = <GeneratePressFontFamilyControlForm
			{ ...control.params }
			value={ value }
...
export default GeneratePressFontFamilyControl;

import GeneratePressRangeControlForm from './GeneratePressRangeControlForm';
 ...
 */
const GeneratePressRangeControl = wp.customize.Control.extend( {
	...
	renderContent: function renderContent() {
		...
		const form = <GeneratePressRangeControlForm
			{ ...control.params }
			value={ value }
...
export default GeneratePressRangeControl;

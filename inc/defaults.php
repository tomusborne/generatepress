	...
	function generate_get_defaults() {
		return apply_filters(
			...
			array(
				...
				'back_to_top' => '',
				'background_color' => 'var(--secondary-background)',
				'text_color' => 'var(--primary-text)',
				'link_color' => 'var(--accent)',
				'link_color_hover' => 'var(--primary-text)',
				'link_color_visited' => '',
	...
	function generate_get_color_defaults() {
		return apply_filters(
			...
			array(
				...
				'header_background_color' => 'var(--primary-background)',
				'header_text_color' => '',
				'header_link_color' => '',
				'header_link_hover_color' => '',
				'site_title_color' => 'var(--primary-text)',
				'site_tagline_color' => 'var(--secondary-text)',
				'navigation_background_color' => 'var(--primary-background)',
				'navigation_text_color' => 'var(--primary-text)',
				'navigation_background_hover_color' => 'var(--primary-background)',
				'navigation_text_hover_color' => 'var(--accent)',
				'navigation_background_current_color' => 'var(--primary-background)',
				'navigation_text_current_color' => 'var(--accent)',
				'subnavigation_background_color' => 'var(--tertiary-background)',
				'subnavigation_text_color' => 'var(--primary-text)',
				'subnavigation_background_hover_color' => 'var(--tertiary-background)',
				'subnavigation_text_hover_color' => 'var(--accent)',
				'subnavigation_background_current_color' => 'var(--tertiary-background)',
				'subnavigation_text_current_color' => 'var(--accent)',
				'navigation_search_background_color' => '',
				'navigation_search_text_color' => '',
				'content_background_color' => 'var(--primary-background)',
				'content_text_color' => '',
				'content_link_color' => '',
				'content_link_hover_color' => '',
				'content_title_color' => '',
				'blog_post_title_color' => 'var(--primary-text)',
				'blog_post_title_hover_color' => 'var(--secondary-text)',
				'entry_meta_text_color' => 'var(--secondary-text)',
				...
				'h5_color' => '',
				'h6_color' => '',
				'sidebar_widget_background_color' => 'var(--primary-background)',
				'sidebar_widget_text_color' => '',
				'sidebar_widget_link_color' => '',
				'sidebar_widget_link_hover_color' => '',
				'sidebar_widget_title_color' => '',
				'footer_widget_background_color' => 'var(--primary-background)',
				'footer_widget_text_color' => '',
				'footer_widget_link_color' => '',
				'footer_widget_link_hover_color' => '',
				'footer_widget_title_color' => '',
				'footer_background_color' => 'var(--primary-background)',
				'footer_text_color' => '',
				'footer_link_color' => '',
				'footer_link_hover_color' => '',
				'form_background_color' => 'var(--secondary-background)',
				'form_text_color' => 'var(--secondary-text)',
				'form_background_color_focus' => 'var(--tertiary-background)',
				'form_text_color_focus' => 'var(--primary-text)',
				'form_border_color' => 'var(--tertiary-background)',
				'form_border_color_focus' => 'var(--tertiary-background)',

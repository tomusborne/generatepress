	...
	function generate_get_color_defaults() {
		return apply_filters(
			...
			array(
				...
				'subnavigation_background_color' => '#e5eaef',
				'subnavigation_text_color' => '#555763',
				'subnavigation_background_hover_color' => '#e5eaef',
				'subnavigation_text_hover_color' => '#7a8896',
				'subnavigation_background_current_color' => '#e5eaef',

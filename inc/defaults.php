	...
	function generate_get_color_defaults() {
		return apply_filters(
			...
			array(
				...
				'form_background_color' => 'rgba(0, 0, 0, 0.02)',
				'form_text_color' => '',
				'form_background_color_focus' => 'rgba(0, 0, 0, 0.01)',
				'form_text_color_focus' => '',
				'form_border_color' => 'rgba(0, 0, 0, 0.2)',
				'form_border_color_focus' => 'rgba(0, 0, 0, 0.3)',

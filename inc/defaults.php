		...
		return apply_filters(
			...
			array(
				...
				'global_colors' => array(
					...
					array(
						'name' => __( 'Base 2', 'generatepress' ),
						'slug' => 'base-2',
						'color' => '#f6f6f6',
					),
					array(
						'name' => __( 'Base 3', 'generatepress' ),
						'slug' => 'base-3',
						'color' => '#f0f0f0',
					),
					array(
					...
					array(
						'name' => __( 'Contrast 2', 'generatepress' ),
						'slug' => 'contrast-2',
						'color' => '#575760',
					),
					array(
	...
	function generate_get_color_defaults() {
		return apply_filters(
			...
			array(
				...
				'header_background_color' => 'var(--base)',
				'header_text_color' => '',
				'header_link_color' => '',
				'header_link_hover_color' => '',
				'site_title_color' => 'var(--contrast)',
				'site_tagline_color' => 'var(--contrast-2)',
				'navigation_background_color' => 'var(--base)',
				...
				'form_border_color' => 'var(--base-3)',
				'form_border_color_focus' => 'var(--base-3)',

<?php
/**
 * These functions output all of our CSS generated by Customizer options.
 *
 * The functions are separated as GP Premium used to overwrite them in their
 * respective add-ons, at some point I want to merge all of them into one function.
 *
 * Functions are wrapped in function_exists() wrappers in case users are using
 * old versions of GP Premium where they're still defined.
 */

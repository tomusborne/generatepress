				...
				wp_localize_script(
					...
					array(
						...
						'customizeSectionUrls' => array(
							'siteIdentitySection' => add_query_arg( urlencode( 'autofocus[section]' ), 'title_tagline', wp_customize_url() ),
							'colorsSection' => add_query_arg( urlencode( 'autofocus[section]' ), 'generate_colors_section', wp_customize_url() ),
							'typographySection' => add_query_arg( urlencode( 'autofocus[section]' ), 'generate_typography_section', wp_customize_url() ),
							'layoutSection' => add_query_arg( urlencode( 'autofocus[panel]' ), 'generate_layout_panel', wp_customize_url() ),
						),
					)
				);
			}

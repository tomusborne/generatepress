			...
			array(
				...
				'sanitize_callback' => function( $settings ) {
					...
					$options = array(
						...
						'marginBottom' => 'generate_sanitize_empty_negative_decimal_integer',
						'marginBottomTablet' => 'generate_sanitize_empty_negative_decimal_integer',
						'marginBottomMobile' => 'generate_sanitize_empty_negative_decimal_integer',

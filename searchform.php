...
<form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="submit" class="search-submit" value="<?php echo apply_filters( 'generate_search_button', _x( 'Search', 'submit button', 'generatepress' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
</form>
